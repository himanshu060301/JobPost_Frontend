...
const Feed = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      const response = await axios.get(`https://jobpost-backend.onrender.com/posts/${query}`);
      setPost(response.data);
    };
    const fetchInitialPosts = async () => {
        const response = await axios.get(`https://jobpost-backend.onrender.com/allPosts`);
